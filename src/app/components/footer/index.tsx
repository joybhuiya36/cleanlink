          ...
          <div className="footer__about-us">
            <div className="footer__logo">
              <Image
                ...
                width={42}
                height={43}
                className="footer__about-us__logo-image"
              />
              <span className="footer__about-us__logo-text">
                {about?.logo?.name}
              </span>
            </div>
            <p className="footer__about-us__description">
              {about?.logo?.description}
            </p>
          </div>
          <div className="footer__question">
            <h3 className="footer__question__header">
              {about?.question?.text}
            </h3>
            ...
            {about?.followItems.map((item, idx) => (
              <div key={idx} className="footer__social-media__logo">
                <Image
                  ...
                  width={22}
                  height={22}
                  className="footer__social-media__logo-image"
                />
